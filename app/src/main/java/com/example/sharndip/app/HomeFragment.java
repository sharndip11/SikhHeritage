...
public class HomeFragment extends Fragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (btn.isPressed()) {
            this.selection = 1;
            //Toast.makeText(this.getActivity(), "Vie d'un Gursikh", Toast.LENGTH_LONG).show();
        } else if (btn2.isPressed()) {
            this.selection = 2;
            //Toast.makeText(this.getActivity(), "Histoire", Toast.LENGTH_LONG).show();
        } else if (btn3.isPressed()) {
            this.selection = 3;
            //Toast.makeText(this.getActivity(), "Biographies", Toast.LENGTH_LONG).show();
        } else if (btn4.isPressed()) {
            this.selection = 4;
            //Toast.makeText(this.getActivity(), "Temples", Toast.LENGTH_LONG).show();
        } else if (btn5.isPressed()) {
            this.selection = 5;
            //Toast.makeText(this.getActivity(), "FAQ", Toast.LENGTH_LONG).show();
        } else if (btn6.isPressed()) {
            this.selection = 6;
            //Toast.makeText(this.getActivity(), "Quizz", Toast.LENGTH_LONG).show();
        } else if (btn7.isPressed()) {
            this.selection = 7;
            //Toast.makeText(this.getActivity(), "Actualités", Toast.LENGTH_LONG).show();
        }
        if (this.selection != 0) {
